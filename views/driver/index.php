...
$groupPassengers = function (array $passengers): array {
    ...
    foreach ($passengers as $passenger) {
        ...
        if ($seat !== '' && !in_array($seat, $grouped[$key]['seats'], true)) {
            $grouped[$key]['seats'][] = $seat;
        }
    }
                    ...
                    <article class="driver-trip-card">
                        <div class="driver-trip-head">
                            <div>
                                ...
                                <h2><?= htmlspecialchars($trip['route_display'] ?? 'Route unavailable') ?></h2>
                                        ...
                                        <tbody>
                                            <?php foreach ($passengers as $passenger): ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars(implode(', ', $passenger['seats'] ?? []) ?: '-') ?></td>
