...
CREATE TABLE `payments` (
  `payment_id_pk` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_payments_bookings1_idx` (`book_id_fk`),
  CONSTRAINT `fk_payments_bookings1` FOREIGN KEY (`book_id_fk`) REFERENCES `bookings` (`book_id_pk`)
